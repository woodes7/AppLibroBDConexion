...
public class ImplementacionConexion implements InterfazConexion {
	...
	private String[] configuracionConexion() {
		...
		try {
			...
			propiedadesConexionPostgresql.load(new FileInputStream(new File("C:\\Users\\Puesto4\\Desktop\\Pablo\\DWS\\Applibro\\src\\ConexionUtil\\conexion_postgresql.properties")));
